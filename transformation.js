...
// Output => i want (top 3, slice) (electronics, filter) products in (ascending order, sort) as an array of object.
 ...
 * Sort by =>  rating
 * slice => Top 3
 * Map => transform objects name from productName to name
 * 
 *  */

const topElectronicProducts = rawApiData
    .filter(product => product.category === "Electronics")
    .sort((a, b) => b.rating - a.rating) // Descending order: highest to lowest.
